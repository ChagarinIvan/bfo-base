...
class NewMasterCupLineSeeder4 extends Seeder
{
    use WithFaker;
    ...
    public function run(): void
    {
        ...
        Person::factory(state: ['id' => 102, 'lastname' => 'Печерный', 'firstname' => 'Валентин', 'citizenship' => 'belarus', 'birthday' => '1951-01-01'])->createOne();
        ...
        ProtocolLine::factory(state: ['id' => 102, 'lastname' => 'Печерный', 'firstname' => 'Валентин', 'club' => 'КСО «Верас»', 'year' => '1951', 'rank' => 'КМС', 'time' => '00:19:53', 'place' => '1', 'distance_id' => 102, 'person_id' => 102])->createOne();
