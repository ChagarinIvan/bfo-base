...
class NewMasterCupLineSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Person::factory(state: ['id' => 103, 'lastname' => 'Сияльский', 'firstname' => 'Владислав', 'citizenship' => 'belarus', 'birthday' => '1966-01-01'])->createOne();
        Person::factory(state: ['id' => 104, 'lastname' => 'Колядко', 'firstname' => 'Иван', 'citizenship' => 'belarus', 'birthday' => '1955-01-01'])->createOne();
        ...
        ProtocolLine::factory(state: ['id' => 103, 'lastname' => 'Сияльский', 'firstname' => 'Владислав', 'club' => 'КСО «Верас»', 'year' => '1966', 'rank' => 'КМС', 'time' => '00:17:22', 'place' => '3', 'distance_id' => 101, 'person_id' => 103])->createOne();
        ProtocolLine::factory(state: ['id' => 104, 'lastname' => 'Колядко', 'firstname' => 'Иван', 'club' => 'КСО «Верас»', 'year' => '2008', 'rank' => 'КМС', 'time' => '00:15:10', 'place' => '1', 'distance_id' => 102, 'person_id' => 104])->createOne();
