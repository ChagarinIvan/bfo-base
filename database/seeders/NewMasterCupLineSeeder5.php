...
class NewMasterCupLineSeeder5 extends Seeder
{
    use WithFaker;
    ...
    public function run(): void
    {
        ...
        Person::factory(state: ['id' => 102, 'lastname' => 'Карась', 'firstname' => 'Олег', 'citizenship' => 'belarus', 'birthday' => '1956-01-01'])->createOne();
        Person::factory(state: ['id' => 103, 'lastname' => 'Печерный', 'firstname' => 'Валентин', 'citizenship' => 'belarus', 'birthday' => '1951-01-01'])->createOne();

        ProtocolLine::factory(state: ['id' => 101, 'lastname' => 'Триденский', 'firstname' => 'Генадий', 'club' => 'КСО «Верас»', 'year' => '1955', 'rank' => 'МС', 'time' => '00:31:08', 'place' => '1', 'complete_rank' => 'КМС', 'distance_id' => 101, 'person_id' => 101])->createOne();
        ProtocolLine::factory(state: ['id' => 102, 'lastname' => 'Карась', 'firstname' => 'Олег', 'club' => 'КСО «Верас»', 'year' => '1956', 'rank' => 'КМС', 'time' => '00:31:33', 'place' => '1', 'distance_id' => 101, 'person_id' => 102])->createOne();
        ProtocolLine::factory(state: ['id' => 103, 'lastname' => 'Печерный', 'firstname' => 'Валентин', 'club' => 'КСО «Верас»', 'year' => '1951', 'rank' => 'КМС', 'time' => '00:35:39', 'place' => '1', 'distance_id' => 102, 'person_id' => 103])->createOne();
