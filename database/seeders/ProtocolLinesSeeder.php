...
class ProtocolLinesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        PersonPayment::factory(state: ['person_id' => 1, 'date' => '2023-01-11', 'year' => 2023])->createOne();
        PersonPayment::factory(state: ['person_id' => 2, 'date' => '2024-01-11', 'year' => 2024])->createOne();
        PersonPayment::factory(state: ['person_id' => 3, 'date' => '2024-01-12', 'year' => 2024])->createOne();
        PersonPayment::factory(state: ['person_id' => 4, 'date' => '2024-01-13', 'year' => 2024])->createOne();
