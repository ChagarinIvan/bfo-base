...
class NewMasterCupLineSeeder2 extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Distance::factory(state: ['id' => 103, 'group_id' => 103, 'event_id' => 101, 'length' => 2700, 'points' => 27])->createOne();
        ...
        Person::factory(state: ['id' => 103, 'lastname' => 'Колядко', 'firstname' => 'Иван', 'citizenship' => 'belarus', 'birthday' => '1956-01-01'])->createOne();
        ...
        ProtocolLine::factory(state: ['id' => 103, 'lastname' => 'Колядко', 'firstname' => 'Иван', 'club' => 'КСО «Верас»', 'year' => '2008', 'rank' => 'КМС', 'time' => '00:15:10', 'place' => '1', 'distance_id' => 102, 'person_id' => 103])->createOne();
