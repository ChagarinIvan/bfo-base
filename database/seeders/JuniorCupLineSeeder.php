...
class JuniorCupLineSeeder extends Seeder
{
    use WithFaker;
    ...
    public function run(): void
    {
        ...
        Group::factory(state: ['id' => 102, 'name' => 'M21Е'])->createOne();
        ...
        ProtocolLine::factory(state: ['id' => 101, 'lastname' => 'Миссюревич', 'firstname' => 'Алексей', 'year' => '2006', 'rank' => 'МС', 'time' => '00:17:20', 'distance_id' => 101, 'person_id' => 101])->createOne();
