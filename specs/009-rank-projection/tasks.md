...
- [x] T054 Уточнить проекцию периодов при повышении: завершать активные более низкие периоды датой повышения и отложить начало последующего выполнения низшего до истечения высшего, не меняя существующий тип выполнения; покрыть `tests/Domain/Rank/RankCalculatorTest.php`.
