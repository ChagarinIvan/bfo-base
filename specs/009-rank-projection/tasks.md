...
**Организация**: задачи сгруппированы по пользовательским историям. `Rank` означает новый string-backed enum; legacy Eloquent aggregate с тем же именем удаляется в рамках миграции, а не сосуществует с ним.
