...
2. Run focused PHPUnit request tests for the four routes in [routes-and-export.md](contracts/routes-and-export.md). Confirm guest, missing resource, CSV content, global cache invalidation across multiple cups, and absence of the retired group export route.
