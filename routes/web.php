...
Route::middleware(['auth'])->group(function () {
    Route::get('/competitions/y{year}/create', [CompetitionController::class, 'create'])->middleware('auth');
    Route::post('/competitions/store', [CompetitionController::class, 'store'])->middleware('auth');
    Route::get('/competitions/y{year}/delete/{competition}', [CompetitionController::class, 'delete'])->middleware('auth');
});
//event
...
Route::post('/login/sign-in', [LoginController::class, 'signIn']);
Route::match(['get', 'post'], '/login/registration', [LoginController::class, 'registration']);
Route::get('/login/auth/{token}', [LoginController::class, 'auth']);
