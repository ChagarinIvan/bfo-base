...
final readonly class RankAssembler
{
    ...
    private function assemble(Rank $rank, ?ProtocolLine $protocolLine): ViewRankDto
    {
        return new ViewRankDto(
            ...
            distanceId: $protocolLine instanceof ProtocolLine ? (string) $protocolLine->distance_id : null,
            protocolLineId: $protocolLine instanceof ProtocolLine ? (string) $protocolLine->id : null,
