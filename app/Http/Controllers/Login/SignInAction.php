...
use App\Http\Controllers\Competition\ShowCompetitionsTableAction;
use App\Models\Year;
...
class SignInAction extends AbstractRedirectAction
{
    ...
    public function __invoke(Request $request): RedirectResponse
    {
        ...
        if ($this->sessionGuard->attempt($authData, true)) {
            ...
            return $this->redirector->action(ShowCompetitionsTableAction::class, Year::actualYear());
        }
