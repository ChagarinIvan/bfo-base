...
use Database\Seeders\NewMasterCupLineSeeder2;
...
final class ShowCupEventGroupActionTest extends TestCase
{
    ...
    public function it_shows_sprint_cup_event_group_action(): void
    {
        ...
        $this->get('/cups/101/101/M_0_/show')
            ...
            ->assertSee('<a href="/app/events/101">Спринт - 2024-04-12</a>', false)
    ...
    public function it_shows_new_master_cup_event_group_action5(): void
    {
        ...
        $this->get('/cups/101/101/W_65_/show')
            ...
            ->assertSee('<a href="/app/competitions/101">Grodno cup</a>', false)
            ->assertSee('<a href="/app/events/101">Спринт - 2025-04-12</a>', false)
    ...
    public function it_shows_new_master_cup_event_group_action6(): void
    {
        ...
        $this->get('/cups/101/101/M_70_/show')
            ->assertStatus(Response::HTTP_OK)
            ->assertSee('<h2 id="up">Master Cup 2025 - 2025</h2>', false)
            ->assertSee('<a href="/app/competitions/101">Grodno cup</a>', false)
            ->assertSee('<a href="/app/events/101">Спринт - 2025-04-12</a>', false)
