...
@section('content')
    ...
    <ul>
        ...
        <li>{{ __('app.api.athletes_list') }} <a href="/api/person?per_page=10&page=1&sort_by=fio&sort_mode=0&search=">/api/person?per_page={PER_PAGE}&page={PAGE}&sort_by={FIELD}&sort_mode=0&search={SEARCH}</a></li>
    </ul>
@endsection
